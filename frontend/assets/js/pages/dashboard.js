...
import { createRafBatcher, rafThrottle, escapeHtml } from '../core.js';
import { formatCurrency, formatNumber, formatCompactRevenue } from '../core.js';
import { fetchAdvancedOverview, getBackendBaseUrl } from '../core.js';
...
async function loadAdvancedAnalytics(force = false) {
    ...
    advancedMetricsInFlight = fetchAdvancedOverview({ timeoutMs: 3200, preferCpp: false })
        .then((payload) => {
